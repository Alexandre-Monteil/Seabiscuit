"""
SEABISCUIT - Quantitative Bet Simulator Engine (French Pari-Mutuel Edition)
Simulates Gagnant, Placé, Duo (Couplé), Trio, and Quinté+ combinations, all driven by
full-field Monte Carlo win probabilities rather than closed-form approximations.
"""
